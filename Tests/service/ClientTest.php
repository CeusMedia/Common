...
import( 'de.ceus-media.service.Client' );
 ...
 *	@version		0.1
 */
class Tests_Service_ClientTest extends PHPUnit_Framework_TestCase
{
	/**
	 *	Constructor.
	 *	@access		public
	...
	{
		$client		= new Tests_Service_ClientInstance();
		...
		$assertion	= FALSE;
		$creation	= $client->getProtectedVar( 'useLogFile' );
		$this->assertEquals( $assertion, $creation );


		$client		= new Tests_Service_ClientInstance( "http//sub.test.tld", TRUE );
	...
	{
		$request	= new Tests_Service_ClientRequestMock;
...
#		$this->markTestIncomplete( 'Incomplete Test' );
	...
	public function testGetRequests()
	{
		$this->markTestIncomplete( 'Incomplete Test' );
		$assertion	= TRUE;
		$creation	= Service_Client::getRequests();
		$this->assertEquals( $assertion, $creation );
	}
...
class Tests_Service_ClientRequestMock extends ADT_OptionObject
{
...
class Tests_Service_ClientInstance extends Service_Client
{
