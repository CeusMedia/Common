...
import( 'de.ceus-media.service/Response' );
/**
 *	TestUnit of Service_Response.
 *	@package		Tests.{classPackage}
 *	@extends		PHPUnit_Framework_TestCase
 ...
 *	@version		0.1
 */
class Tests_Service_ResponseTest extends PHPUnit_Framework_TestCase
{
	/**
	 *	Constructor.
	 *	@access		public
	...
	{
		$this->instance	= new Tests_Service_ResponseInstance;
		$this->data		= array(
			'string'	=> "VALUE1",
			'bool'		=> TRUE,
			'double'	=> M_PI,
...
class Tests_Service_ResponseInstance extends Service_Response
{
