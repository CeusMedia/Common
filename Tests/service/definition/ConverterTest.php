<?php
/**
 *	TestUnit of Service_Definition_Converter.
 *	@package		Tests.{classPackage}
 *	@extends		PHPUnit_Framework_TestCase
 *	@uses			Service_Definition_Converter
...
import( 'de.ceus-media.service.definition/Converter' );
/**
 *	TestUnit of Service_Definition_Converter.
 *	@package		Tests.{classPackage}
 *	@extends		PHPUnit_Framework_TestCase
 ...
 *	@version		0.1
 */
class Tests_Service_Definition_ConverterTest extends PHPUnit_Framework_TestCase
{
	/**
	 *	Constructor.
	 *	@access		public
	...
	{
		Service_Definition_Converter::convertJsonFileToXmlFile( $this->fileJson, $this->fileTemp );
	...
	{
		Service_Definition_Converter::convertJsonFileToYamlFile( $this->fileJson, $this->fileTemp );
	...
	{
		Service_Definition_Converter::convertXmlFileToJsonFile( $this->fileXml, $this->fileTemp );
	...
	{
		Service_Definition_Converter::convertXmlFileToYamlFile( $this->fileXml, $this->fileTemp );
		$assertion	= file_get_contents( $this->fileYaml );
		$creation	= file_get_contents( $this->fileTemp );
		$this->assertEquals( $assertion, $creation );
	}
	...
	{
		Service_Definition_Converter::convertYamlFileToJsonFile( $this->fileYaml, $this->fileTemp );
		$assertion	= file_get_contents( $this->fileJson );
		$creation	= file_get_contents( $this->fileTemp );
		$this->assertEquals( $assertion, $creation );
	}
	...
	{
		Service_Definition_Converter::convertYamlFileToXmlFile( $this->fileYaml, $this->fileTemp );
		$assertion	= file_get_contents( $this->fileXml );
		$creation	= file_get_contents( $this->fileTemp );
		$this->assertEquals( $assertion, $creation );
	}
