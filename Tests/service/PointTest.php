 ...
 *	@version		0.1
 */
class Tests_Service_PointTest extends PHPUnit_Framework_TestCase
{
	/**
	 *	Constructor.
	 *	@access		public
	...
	public function test__construct()
	{
		...
		$assertion	= TRUE;
		$creation	= Service_Point::__construct();
	...
	public function testCallService()
	{
		$this->markTestIncomplete( 'Incomplete Test' );
		$assertion	= TRUE;
		$creation	= Service_Point::callService();
		$this->assertEquals( $assertion, $creation );
	}
	...
	public function testGetDefaultServiceFormat()
	{
		$this->markTestIncomplete( 'Incomplete Test' );
		$assertion	= TRUE;
		$creation	= Service_Point::getDefaultServiceFormat();
		$this->assertEquals( $assertion, $creation );
	}
	...
	public function testGetServiceClass()
	{
		$this->markTestIncomplete( 'Incomplete Test' );
		$assertion	= TRUE;
		$creation	= Service_Point::getServiceClass();
		$this->assertEquals( $assertion, $creation );
	}
	...
	public function testGetServiceDescription()
	{
		$this->markTestIncomplete( 'Incomplete Test' );
		$assertion	= TRUE;
		$creation	= Service_Point::getServiceDescription();
		$this->assertEquals( $assertion, $creation );
	}
	...
	public function testGetServiceFormats()
	{
		$this->markTestIncomplete( 'Incomplete Test' );
		$assertion	= TRUE;
		$creation	= Service_Point::getServiceFormats();
		$this->assertEquals( $assertion, $creation );
	}
	...
	public function testGetServices()
	{
		$this->markTestIncomplete( 'Incomplete Test' );
		$assertion	= TRUE;
		$creation	= Service_Point::getServices();
		$this->assertEquals( $assertion, $creation );
	}
	...
	public function testGetServiceExamples()
	{
		$this->markTestIncomplete( 'Incomplete Test' );
		$assertion	= TRUE;
		$creation	= Service_Point::getServiceExamples();
		$this->assertEquals( $assertion, $creation );
	}
	...
	public function testGetServiceParameters()
	{
		$this->markTestIncomplete( 'Incomplete Test' );
		$assertion	= TRUE;
		$creation	= Service_Point::getServiceParameters();
		$this->assertEquals( $assertion, $creation );
	}
	...
	public function testGetSyntax()
	{
		$this->markTestIncomplete( 'Incomplete Test' );
		$assertion	= TRUE;
		$creation	= Service_Point::getSyntax();
		$this->assertEquals( $assertion, $creation );
	}
	...
	public function testGetTitle()
	{
		$this->markTestIncomplete( 'Incomplete Test' );
		$assertion	= TRUE;
		$creation	= Service_Point::getTitle();
		$this->assertEquals( $assertion, $creation );
	}
}
?>