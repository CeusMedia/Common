 ...
 *	@version		0.1
 */
class Tests_Database_StatementBuilderTest extends PHPUnit_Framework_TestCase
{
	/**
	...
	{
		$this->builder	= new Tests_Database_StatementBuilderInstance( "prefix_" );
	}
	...
	public function testConstruct()
	{
		...
		$builder	= new Tests_Database_StatementBuilderInstance( $prefix, $keys, $tables, $conditions, $groupings );
...
class Tests_Database_StatementBuilderInstance extends Database_StatementBuilder
{
