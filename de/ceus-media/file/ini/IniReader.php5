...
class IniReader extends File
{
	 ...
	 *	@return		string
	 */
	function getProperty( $key, $section = false )
	{
		if( $this->usesSections() )
		{
	 ...
	 *	@return		bool
	 */
	function isProperty( $key, $section = false)
	{
		if( $this->usesSections() )
	 ...
	 *	@return		bool
	 */
	function isActiveProperty( $key, $section = false )
	{
		if( $this->usesSections() )
		{
	 ...
	 *	@return		array
	 */
	function getPropertyList( $activeOnly = false )
	{
		$properties = array();
		if( $this->usesSections() )
		{
	 ...
	 *	@return		string
	 */
	function getComment( $key, $section = false )
	{
	 ...
	 */
	function getComments( $section = false)
	{
	 ...
	 *	@return		array
	 */
	function toArray( $activeOnly = false )
	{
	 ...
	 */
	function toCommentedArray( $activeOnly = false )
	{
		$a = Array();
		if( $this->usesSections() )
		{
	 ...
	 *	@access		public
	 *	@param		string		$key		Key of commented Property
	 *	@return		array
	 */
	function usesSections( $set = 0 )
	{
		if( is_bool( $set ) )
