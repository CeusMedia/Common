...
define( 'FMT_DATE_DE', '%d.%m.%Y' );
define( 'FMT_DATE_FR', '%d/%m/%Y' );
define( 'FMT_DATE_US', '%m/%d/%Y' );
define( 'FMT_DATE_ISO', '%Y%m%dT%H%M%S' );
define( 'FMT_DATE_LDAP', '%Y%m%d%H%M%SZ' );
define( 'FMT_DATE_MYSQL', '%Y-%m-%d %H:%M:%S' );
define( 'FMT_DATE_RFC822', '%a, %d %b %Y %H:%M:%S' );
define( 'FMT_DATETIME_DE', '%d.%m.%Y-%H:%M:%S' );
