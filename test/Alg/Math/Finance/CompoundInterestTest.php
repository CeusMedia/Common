...
class Test_Alg_Math_Finance_CompoundInterestTest extends Test_Case
{
	...
	{
		$assertion	= 1100;
		$creation	= Alg_Math_Finance_CompoundInterest::calculateFutureAmount( 1000, 10, 1 );
		$this->assertEquals( $assertion, $creation );

		$assertion	= 1210;
		$creation	= (int) Alg_Math_Finance_CompoundInterest::calculateFutureAmount( 1000, 10, 2 );
		$this->assertEquals( $assertion, $creation );

		$assertion	= 1331;
		$creation	= (int) Alg_Math_Finance_CompoundInterest::calculateFutureAmount( 1000, 10, 3 );
		$this->assertEquals( $assertion, $creation );
	}
	...
	{
		$assertion	= 1000;
		$creation	= round( Alg_Math_Finance_CompoundInterest::calculatePresentAmount( 1100, 10, 1 ) );
		$this->assertEquals( $assertion, $creation );

		$assertion	= 1000;
		$creation	= round( Alg_Math_Finance_CompoundInterest::calculatePresentAmount( 1210, 10, 2 ) );
		$this->assertEquals( $assertion, $creation );

		$assertion	= 1000;
		$creation	= round( Alg_Math_Finance_CompoundInterest::calculatePresentAmount( 1331, 10, 3 ) );
		$this->assertEquals( $assertion, $creation );
	}
	...
	{
		$assertion	= 10;
		$creation	= round( Alg_Math_Finance_CompoundInterest::calculateInterest( 1000, 1100, 1 ) );
		$this->assertEquals( $assertion, $creation );

		$assertion	= 10;
		$creation	= round( Alg_Math_Finance_CompoundInterest::calculateInterest( 1000, 1210, 2 ) );
		$this->assertEquals( $assertion, $creation );

		$assertion	= 10;
		$creation	= round( Alg_Math_Finance_CompoundInterest::calculateInterest( 1000, 1331, 3 ) );
		$this->assertEquals( $assertion, $creation );
	}
